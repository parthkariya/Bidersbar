...
const MenuScreen = () => {
  ...
  return (
    <div>
                    ...
                    return (
                      <>
                            ...
                            {item.veg ? (
                              <div className="menu_single_card">
                                ...
                                <div className="menu_card_title_wrap">
                                  ...
                                  <img
                                    src={item.veg ? images.veg : images.nonveg}
                                  />
                                </div>
                                ...
                                <p className="des_4 ">{item.des}</p>
                                <button className="mx-1 manu_card_add_btn">
                                  Add
                                </button>
                              </div>
                            ) : null}
                        ...
                        {gettogg2 === false && gettogg === false ? (
                          <>
                            <div className="menu_single_card">
                              <img src={item.image} className="menu_card_img" />
                              <div className="menu_card_title_wrap">
                                <h3 className="h3">{item.title}</h3>
                                <img
                                  src={item.veg ? images.veg : images.nonveg}
      ...
      <button className="menu_float" onClick={() => setMenuTogg(!getmenutogg)}>
      ...
      {getmenutogg ? (
        <div className="menu_model_float">
          {order_cat_responce && order_cat_responce.length > 0 ? (
            order_cat_responce.map((itm, ind) => {
              return (
                <button className="menu_model_text_wrapp">
